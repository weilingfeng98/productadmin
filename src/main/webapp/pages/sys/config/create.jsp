...
<head>
	<title><%=TsysConfigMo.TABLE_ALIAS%>新增</title>
...
<div class="title01">
	...
	<form id="form1" action="${ctx}/sys/config/save.do" method="post">
		...
		<table cellpadding="0" cellspacing="0" class="table00" style="width: 100%">
			...
			<tr>	
				...
				<td>
				<input id="keyName" name="keyName" type="text" class="input04"  tip="请输入KEY值" check="2" />
			...
			<tr>	
				...
				<td>
				<input id="value" name="value" type="text" class="input04"   />
			...
			<tr>	
				...
				<td>
				<input id="memo" name="memo" type="text" class="input04"   />
			...
			<tr>	
				...
				<td>
				<input id="sn" name="sn" type="text" class="input04"  tip="请输入序号，必须为数字" check="2"  />
				<span class="required">*</span>
				</td>
			</tr>
...
<!-- 				</td>	 -->
<!-- 				<td> -->
<!-- 				<input id="type" name="type" type="text" class="input04"   /> -->
...
<!-- 			</tr> -->
			...
			<tr>	
				...
				<td>
<!-- 				<input id="enabled" name="enabled" type="text" class="input04"  required="true" /> -->
			...
			<tr>	
				...
				<td>
<!-- 				<input id="module" name="module" type="text" class="input04"   /> -->
				<select name="module" id="module" class="input04"  >
			       <option value="">请选择...</option>
			        <option value="ALL" <c:if test="${module == 'ALL'}">selected="selected"</c:if> >系统</option>
			        <option value="HOTEL" <c:if test="${module == 'PRODUCT'}">selected="selected"</c:if> >商品管理</option>
			    </select>
				</td>
			</tr>
			...
			<tr>	
				...
				<td>
<!-- 				<input id="app" name="app" type="text" class="input04"   /> -->
				<input name="app" value="01" type="checkbox" />PRODUCTADMIN
				</td>
			</tr>
			<tr>	
