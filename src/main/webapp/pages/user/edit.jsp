...
<head>
	<title><%=UserInfoMo.TABLE_ALIAS%>编辑</title>
...
<body>
<div class="title01">
	<h2>修改<%=UserInfoMo.TABLE_ALIAS%></h2>
</div>
	<form id="form1" action="${ctx}/sys/user/update.do" method="post">
		...
		<table cellpadding="0" cellspacing="0" class="table00" style="width: 100%">
			...
			<tr>	
				...
				<td>
				<input id="userName" name="userName" value="<c:out value="${model.userName}"/>" type="text" class="input04"  required="true" />
			...
			<tr>	
				...
				<td>
				<input id="pwd" name="pwd" value="<c:out value="${model.pwd}"/>" type="text" class="input04"  required="true" />
				<span class="required">*</span>
				</td>
			</tr>
			...
			<tr>	
				...
				<td>
				<input id="realName" name="realName" value="<c:out value="${model.realName}"/>" type="text" class="input04"  required="true" />
				<span class="required">*</span>
				</td>
			</tr>
			...
			<tr>	
				...
				<td>
				<input id="empNo" name="empNo" value="<c:out value="${model.empNo}"/>" type="text" class="input04"   />
			...
			<tr>	
				...
				<td>
				<input id="sex" name="sex" value="<c:out value="${model.sex}"/>" type="text" class="input04"   />
			...
			<tr>	
				...
				<td>
				<input id="job" name="job" value="<c:out value="${model.job}"/>" type="text" class="input04"   />
			...
			<tr>	
				...
				<td>
				<input id="deptId" name="deptId" value="<c:out value="${model.deptId}"/>" type="text" class="input04"   />
			...
			<tr>	
				...
				<td>
				<input id="deptCode" name="deptCode" value="<c:out value="${model.deptCode}"/>" type="text" class="input04"   />
			...
			<tr>	
				...
				<td>
				<input id="isAdmin" name="isAdmin" value="<c:out value="${model.isAdmin}"/>" type="text" class="input04"   />
			...
			<tr>	
				...
				<td>
				<input id="roleId" name="roleId" value="<c:out value="${model.roleId}"/>" type="text" class="input04"   />
			...
			<tr>	
				...
				<td>
				<input id="updator" name="updator" value="<c:out value="${model.updator}"/>" type="text" class="input04"   />
